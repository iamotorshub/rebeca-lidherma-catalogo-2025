...
// Actualizado con datos del CSV proporcionado por el usuario
...
export const mockProducts = [
  ...
  // HYDRAPORE - Hidratación profunda
  {
    id: "16",
  ...
  },
  {
    ...
    tipo: "Gel crema",
    tipo_piel: ["Piel grasa", "Piel mixta"],
    funcion: ["Hidratación", "Control poros", "Equilibrio"],
  ...
  },
  {
    ...
    tipo_piel: ["Todos los tipos"],
    funcion: ["Hidratación", "Equilibrio", "Suavidad"],
    imagen_url: "https://sellercenterlidhermaarg.vtexassets.com/arquivos/ids/156564-800-auto?v=638888036942670000&width=800&height=auto&aspect=true",
    disponible: true,
    stock: 16,
    cuotas_sin_interes: false
  ...
  // MATT BALANCE - Piel grasa
  {
    id: "19",
    slug: "matt-balance-cleansing-gel-180ml",
    linea: "Matt Balance",
    categoria_L1: "Cuidado de la piel",
    ...
    tipo: "Gel limpiador",
    tipo_piel: ["Piel grasa", "Piel mixta"],
    funcion: ["Limpieza profunda", "Control oleosidad", "Equilibrio"],
  ...
  },
  {
    ...
    tipo_piel: ["Piel grasa", "Piel mixta"],
    funcion: ["Equilibrio", "Control oleosidad", "Hidratación"],
  ...
  },
  {
    ...
    tipo_piel: ["Piel grasa", "Piel mixta"],
    funcion: ["Control oleosidad", "Hidratación", "Equilibrio"],
